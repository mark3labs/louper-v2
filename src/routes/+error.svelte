<div class="flex items-center justify-center">
  <div class="px-40 py-20 bg-base-300 rounded-md shadow-xl">
    <div class="flex flex-col items-center">
      ...
      <p class="mb-2 text-center text-gray-500 md:text-lg">
        Are you sure this is a diamond contract?
      </p>
      <p class="mb-8 text-center text-gray-500 md:text-lg">
        Please make sure that the contract has a "DiamondLoupeFacet" that implements the "facets()"
        method.
      </p>

      <a href="/" class="btn btn-primary font-semibold">Go home</a>
    </div>
  </div>
</div>
